...
A comprehensive web application for analyzing urban mobility patterns with interactive visualizations, real-time data processing, and advanced analytics.
...
### 🎯 Core Functionality
- **Interactive Dashboard** - Real-time urban mobility analytics
- **ETL Pipeline** - Robust data processing from CSV to SQLite
- **API Endpoints** - RESTful API for data consumption
- **User Authentication** - Secure login system
- **Responsive Design** - Works on desktop and mobile

### 📊 Visualizations
- **Trip Density by Hour** - Time-based trip analysis with filters
- **Duration Distribution** - Trip duration patterns by passenger count
- **Vendor Performance** - Comparative analysis of service providers
- **Interactive Heatmap** - Geographic visualization of pickup/dropoff patterns
- **Real-time Statistics** - Live dashboard metrics

### 🔧 Technical Features
- **Robust ETL** - Handles variant CSV schemas automatically
- **Calculated Metrics** - Speed, fare/km, tip ratios
- **Database Optimization** - Efficient SQLite storage with indexing
- **Error Handling** - Comprehensive logging and error recovery
- **Scalable Architecture** - Modular Flask backend with clean separation
...
cd Urban-Mobility-Data-Explorer---Cohort-3-Group-1
```
...
**Linux/Mac:**
```bash
python3 -m venv urbanmobility
source urbanmobility/bin/activate
```

**Windows:**
```cmd
python -m venv urbanmobility
urbanmobility\Scripts\activate
```
